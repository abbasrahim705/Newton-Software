                                ...
                                <tbody>
                                    ...
                                    ?>
                                            ...
                                            ?>
                                                ...
                                                <td align="left" class="text text-left">
                                                    <?php
                                                    if ($fee_value->installment_due_date == "0000-00-00") {
                                                    } else {

                                                        if ($fee_value->installment_due_date) {
                                                            echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($fee_value->installment_due_date));
                                                        }
                                                    }
                                                    ?>
                                                </td>
                                                ...
                                                ?>
                                                        <tr class="white-td">
                                                            ...
                                                            <td class="text text-left"><?php echo ($this->lang->line(strtolower($fee_deposits_value->payment_mode)) ? $this->lang->line(strtolower($fee_deposits_value->payment_mode)) : $fee_deposits_value->payment_mode); ?></td>
