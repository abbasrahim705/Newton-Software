                    ...
                    <div class="col-sm-9">
                        ...
                        ?>
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="payment_mode_fee" value="<?php echo str_replace(' ', '_', $payment_method); ?>" <?php echo (strtolower($payment_method) == 'cash') ? 'checked="checked"' : ''; ?>>
                                    <?php echo ($this->lang->line(strtolower($payment_method)) ? $this->lang->line(strtolower($payment_method)) : $payment_method); ?>
                                </label>
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="payment_mode_fee" value="tamara"> <?php echo $this->lang->line('tamara'); ?></label>
                            <label class="radio-inline">
                                <input type="radio" name="payment_mode_fee" value="tabby"><?php echo $this->lang->line('tabby'); ?></label>
                            <label class="radio-inline">
