                                                                            ...
                                                                            <ul class="list-group student_fee_list ui-sortable">
                                                                                ...
                                                                                ?>
                                                                                    <li class="list-group-item">
                                                                                        ...
                                                                                        <small class="due_date"><i class="fa fa-calendar"></i>
                                                                                            <!-- <?php echo $this->customlib->dateformat($fee_type_value->due_date); ?> -->
                                                                                            <?php
                                                                                            if (strtolower($fee_type_value->type) != 'full payment') { ?>
                                                                                                <input id="installment_id" name="installment_id[]" placeholder="" type="hidden" class="form-control date" autocomplete="off" value="<?=$fee_type_value->id?>">
                                                                                                <input id="due_date" name="due_date[]" placeholder="" type="text" class="form-control date" autocomplete="off">
                                                                                            <?php } ?>
                                                                                        </small>
                                                                                        <div class="tools">
